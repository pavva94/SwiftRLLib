...
//
//  Abstract:
//  Manager responsible for updating and using the correct Model at runtime.

import CoreML

/// Class that handles predictions and updating of AppleRLModel model.
//struct ModelUpdater {
//    // MARK: - Private Type Properties
//    /// The updated Model model.
//    private static var updatedModel: AppleRLModel?
//    /// The default Model model.
//    private static var defaultModel: AppleRLModel {
//        do {
...
//    private static var liveModel: AppleRLModel {
...
//    private static let defaultModelURL = AppleRLModel.urlOfModelInThisBundle
...
//    static func updateWith(trainingData: MLBatchProvider, parameters: MLModelConfiguration,
...
//    }
//    
//    /// Deletes the updated model and reverts back to original Model.
...
//    }
//    
//    static func saveUpdatedModel(_ model: MLModel & MLWritable) {
//        let fileManager = FileManager.default
//        do {
//            // Create a directory for the updated model.
//            try fileManager.createDirectory(at: tempUpdatedModelURL,
...
//            
//            // Save the updated model to temporary filename.
//            try model.write(to: tempUpdatedModelURL)
//            
//            // Replace any previously updated model with this one.
//            _ = try fileManager.replaceItemAt(updatedModelURL,
//                                              withItemAt: tempUpdatedModelURL)
